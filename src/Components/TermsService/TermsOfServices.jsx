...
import img from "../../assets/image/term.png";
          ...
          <div class="mx-auto w-full max-w-5xl px-5 md:px-10 py-12 md:py-16 lg:py-20">
            ...
            <div class="mb-6 flex flex-col items-start gap-y-3">
              ...
              <p class="text-sm sm:text-base">
                ...
                timelines, and pricing for each project will be
              </p>
            </div>
            ...
            <div class="mb-6 flex flex-col items-start gap-y-3">
              ...
              <p class="text-sm sm:text-base">
                ...
                necessary permissions, licenses, or copyrights for materials
                provided to the Company for use in the project. The client
                acknowledges that delays or failures in providing required
                materials or feedback may impact project timelines and
                deliverables.
              </p>
            </div>
            ...
            <div class="mb-6 flex flex-col items-start gap-y-3">
              ...
              <p class="text-sm sm:text-base">
                ...
                full payment, unless otherwise agreed upon in writing. The
                client warrants that any materials provided to the Company for
                use in the project do not infringe upon the intellectual
            ...
            <div class="mb-6 flex flex-col items-start gap-y-3">
              ...
              <p class="text-sm sm:text-base">
                ...
                agreement or proposal. The Company reserves the right to suspend
                or terminate services in the event of non-payment or late
                payment.
              </p>
            </div>
            ...
            <div class="mb-6 flex flex-col items-start gap-y-3">
              ...
              <p class="text-sm sm:text-base">
                ...
                that the Company's liability is limited to the amount paid for
