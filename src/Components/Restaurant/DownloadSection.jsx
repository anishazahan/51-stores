  ...
  return (
    <div className="py-20 flex flex-col justify-center custom-container">
      ...
      <p className="max-w-lg text-sm text-center mt-5 text-lightGray font-medium mx-auto">
        Impress your visitors with a high-end way of taking orders, send them to
        the kitchen instantly on display or tickets. Manage your orders and
        receive payments.
      </p>
      <p className="max-w-lg text-sm text-center mt-8 text-lightGray font-medium mx-auto">
        ...
        system do all the job: order management, inventory management, employee
        management, visual sales analytics, customers loyalty program, and a lot
        more.
      </p>
